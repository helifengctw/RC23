...
set(MSG_I_FLAGS "-Iyolov5:/home/hlf/ws_repo/v5_ws/src/yolov5/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg;-Isensor_msgs:/opt/ros/noetic/share/sensor_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/hlf/ws_repo/v5_ws/src/yolov5/msg/result.msg" NAME_WE)
add_custom_target(_yolov5_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "yolov5" "/home/hlf/ws_repo/v5_ws/src/yolov5/msg/result.msg" ""
)
...
_generate_msg_cpp(yolov5
  "/home/hlf/ws_repo/v5_ws/src/yolov5/msg/result.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/yolov5)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/yolov5\")")
  # install generated code
  install(
